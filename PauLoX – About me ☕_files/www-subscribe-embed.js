...
ic&&(hc=ic?ic[1]:"");if(B){var jc=fc();if(null!=jc&&jc>parseFloat(hc)){gc=String(jc);break a}}gc=hc}var kc=gc,Tb={};function lc(a){return Sb(a,function(){return 0<=sb(kc,a)})}
...
var xc=new wc("undefined"==typeof document?null:document);var yc=!Xb&&!B||B&&9<=Number(nc)||Xb&&lc("1.9.1"),zc=B&&!lc("9");function D(a,b){this.x=void 0!==a?a:0;this.y=void 0!==b?b:0}
...
function Lc(a){var b=Mc(a);a=Nc(a);return B&&lc("10")&&a.pageYOffset!=b.scrollTop?new D(b.scrollLeft,b.scrollTop):new D(a.pageXOffset||b.scrollLeft,a.pageYOffset||b.scrollTop)}
...
var Wc={SCRIPT:1,STYLE:1,HEAD:1,IFRAME:1,OBJECT:1},Xc={IMG:" ",BR:"\n"};function Yc(a){var b;if((b="A"==a.tagName&&a.hasAttribute("href")||"INPUT"==a.tagName||"TEXTAREA"==a.tagName||"SELECT"==a.tagName||"BUTTON"==a.tagName?!a.disabled&&(!Zc(a)||$c(a)):Zc(a)&&$c(a))&&B){var c;!Ca(a.getBoundingClientRect)||B&&null==a.parentElement?c={height:a.offsetHeight,width:a.offsetWidth}:c=a.getBoundingClientRect();a=null!=c&&0<c.height&&0<c.width}else a=b;return a}
function Zc(a){return B&&!lc("9")?(a=a.getAttributeNode("tabindex"),null!=a&&a.specified):a.hasAttribute("tabindex")}
...
function b(q){for(var t=h,r=0;64>r;r+=4)t[r/4]=q[r]<<24|q[r+1]<<16|q[r+2]<<8|q[r+3];for(r=16;80>r;r++)q=t[r-3]^t[r-8]^t[r-14]^t[r-16],t[r]=(q<<1|q>>>31)&4294967295;q=e[0];var u=e[1],Q=e[2],F=e[3],Xa=e[4];for(r=0;80>r;r++){if(40>r)if(20>r){var da=F^u&(Q^F);var xa=1518500249}else da=u^Q^F,xa=1859775393;else 60>r?(da=u&Q|F&(u|Q),xa=2400959708):(da=u^Q^F,xa=3395469782);da=((q<<5|q>>>27)&4294967295)+da+Xa+xa+t[r]&4294967295;Xa=F;F=Q;Q=(u<<30|u>>>2)&4294967295;u=q;q=da}e[0]=e[0]+q&4294967295;e[1]=e[1]+
u&4294967295;e[2]=e[2]+Q&4294967295;e[3]=e[3]+F&4294967295;e[4]=e[4]+Xa&4294967295}
...
;function be(a,b,c){var d=String(n.location.href);return d&&a&&b?[b,ce(Pd(d),a,c||null)].join(" "):null}
function ce(a,b,c){var d=[],e=[];if(1==(Aa(c)?2:1))return e=[b,a],z(d,function(g){e.push(g)}),de(e.join(" "));
...
function de(a){var b=ae();b.update(a);return b.Ta().toLowerCase()}
;var ee={};function fe(){var a=Pd(String(n.location.href)),b=(a=0==a.indexOf("https:")||0==a.indexOf("chrome-extension:"))?n.__SAPISID:n.__APISID;if(!b){var c=new wc(document);(b=c.get(a?"SAPISID":"APISID"))||(b=c.get("__Secure-3PAPISID"))}return b}
function ge(){var a=!!ee.ENABLE_FPA_3P_COOKIES_MOD,b=!!ee.ENABLE_FPA_3P_COOKIES_REFACTORED_IS_LOGGED_IN_MOD;a&&b?(a=n.__SAPISID||n.__APISID||n.__OVERRIDE_SID)?a=!0:(a=new wc(document),a=a.get("SAPISID")||a.get("APISID")||a.get("__Secure-3PAPISID")||a.get("SID"),a=!!a):a?(a=fe(),a||(a=new wc(document),a=n.__OVERRIDE_SID||a.get("SID")),a=!!a):(a=n.__OVERRIDE_SID,null==a&&(a=(new wc(document)).get("SID")),a=!!a);return a}
function he(a){var b=!!ee.ENABLE_FPA_3P_COOKIES_MOD,c=!!ee.ENABLE_FPA_3P_COOKIES_REFACTORED_IS_LOGGED_IN_MOD;if(b&&c)a:{b=Pd(String(n.location.href));if(ge()&&(c=(b=0==b.indexOf("https:")||0==b.indexOf("chrome-extension:"))?n.__SAPISID:n.__APISID,c||(c=new wc(document),c=c.get(b?"SAPISID":"APISID")||c.get("__Secure-3PAPISID")),c)){a=be(c,b?"SAPISIDHASH":"APISIDHASH",a);break a}a=null}else if(b)(b=fe())?(c=Pd(String(n.location.href)),a=be(b,0==c.indexOf("https:")||0==c.indexOf("chrome-extension:")?
"SAPISIDHASH":"APISIDHASH",a)):a=null;else a:{b=Pd(String(n.location.href));if(ge()&&(c=(b=0==b.indexOf("https:")||0==b.indexOf("chrome-extension:"))?n.__SAPISID:n.__APISID,null==c&&(c=(new wc(document)).get(b?"SAPISID":"APISID")),c)){a=be(c,b?"SAPISIDHASH":"APISIDHASH",a);break a}a=null}return a}
;var ie=I(J,"perf",Wd());I(ie,"g",Wd());var je=I(ie,"i",Wd());I(ie,"r",[]);Wd();Wd();function ke(a,b,c){b&&0<b.length&&(b=le(b),c&&0<c.length&&(b+="___"+le(c)),28<b.length&&(b=b.substr(0,28)+(b.length-28)),c=b,b=I(je,"_p",Wd()),I(b,c,Wd())[a]=(new Date).getTime(),b=ie.r,"function"===typeof b?b(a,"_p",c):b.push([a,"_p",c]))}
function le(a){return a.join("__").replace(/\./g,"_").replace(/\-/g,"_").replace(/,/g,"_")}
;var me=Wd(),ne=[];function oe(a){throw Error("Bad hint"+(a?": "+a:""));}
...
var pe=/^(\/[a-zA-Z0-9_\-]+)+$/,qe=[/\/amp\//,/\/amp$/,/^\/amp$/],re=/^[a-zA-Z0-9\-_\.,!]+$/,se=/^gapi\.loaded_[0-9]+$/,te=/^[a-zA-Z0-9,._-]+$/;function ue(a,b,c,d){var e=a.split(";"),f=e.shift(),h=me[f],g=null;h?g=h(e,b,c,d):oe("no hint processor for: "+f);g||oe("failed to generate load url");b=g;c=b.match(ve);(d=b.match(we))&&1===d.length&&xe.test(b)&&c&&1===c.length||oe("failed sanity: "+a);return g}
function ye(a,b,c,d){function e(f){return encodeURIComponent(f).replace(/%2C/g,",")}
a=ze(a);se.test(c)||oe("invalid_callback");b=Ae(b);d=d&&d.length?Ae(d):null;return[encodeURIComponent(a.pathPrefix).replace(/%2C/g,",").replace(/%2F/g,"/"),"/k=",e(a.version),"/m=",e(b),d?"/exm="+e(d):"","/rt=j/sv=1/d=1/ed=1",a.ga?"/am="+e(a.ga):"",a.Da?"/rs="+e(a.Da):"",a.Na?"/t="+e(a.Na):"","/cb=",e(c)].join("")}
function ze(a){"/"!==a.charAt(0)&&oe("relative path");for(var b=a.substring(1).split("/"),c=[];b.length;){a=b.shift();if(!a.length||0==a.indexOf("."))oe("empty/relative directory");else if(0<a.indexOf("=")){b.unshift(a);break}c.push(a)}a={};for(var d=0,e=b.length;d<e;++d){var f=b[d].split("="),h=decodeURIComponent(f[0]),g=decodeURIComponent(f[1]);2==f.length&&h&&g&&(a[h]=a[h]||g)}b="/"+c.join("/");pe.test(b)||oe("invalid_prefix");c=0;for(d=qe.length;c<d;++c)qe[c].test(b)&&oe("invalid_prefix");c=Be(a,
"k",!0);d=Be(a,"am");e=Be(a,"rs");a=Be(a,"t");return{pathPrefix:b,version:c,ga:d,Da:e,Na:a}}
...
var xe=/^https?:\/\/[a-z0-9_.-]+\.google(rs)?\.com(:\d+)?\/[a-zA-Z0-9_.,!=\-\/]+$/,we=/\/cb=/g,ve=/\/\//g;function Ce(){var a=Yd();if(!a)throw Error("Bad hint");return a}
...
function Ge(){var a=J.nonce;return void 0!==a?a&&a===String(a)&&a.match(Ee)?a:J.nonce=null:Rd.querySelector?(a=Rd.querySelector("script[nonce]"))?(a=a.nonce||a.getAttribute("nonce")||"",a&&a===String(a)&&a.match(Ee)?J.nonce=a:J.nonce=null):null:null}
function He(a){if("loading"!=Rd.readyState)Ie(a);else{var b=Ge(),c="";null!==b&&(c=' nonce="'+b+'"');a="<"+De+' src="'+encodeURI(a)+'"'+c+"></"+De+">";Rd.write(a)}}
function Ie(a){var b=Rd.createElement(De);b.setAttribute("src",a);a=Ge();null!==a&&b.setAttribute("nonce",a);b.async="true";(a=Rd.getElementsByTagName(De)[0])?a.parentNode.insertBefore(b,a):(Rd.head||Rd.body||Rd.documentElement).appendChild(b)}
...
function Ke(a,b,c){Le(function(){var d=b===Yd()?I(Xd,"_",Wd()):Wd();d=I($d(b),"_",d);a(d)},c)}
function Me(a,b){var c=b||{};"function"==typeof b&&(c={},c.callback=b);Je(a,c);var d=a?a.split(":"):[],e=c.h||Ce(),f=I(J,"ah",Wd());if(f["::"]&&d.length){for(var h=[],g=null;g=d.shift();){var k=g.split(".");k=f[g]||f[k[1]&&"ns:"+k[0]||""]||e;var l=h.length&&h[h.length-1]||null,p=l;l&&l.hint==k||(p={hint:k,features:[]},h.push(p));p.features.push(g)}var q=h.length;if(1<q){var t=c.callback;t&&(c.callback=function(){0==--q&&t()})}for(;d=h.shift();)Ne(d.features,c,d.hint)}else Ne(d||[],c,e)}
function Ne(a,b,c){function d(da,xa){if(q)return 0;Qd.clearTimeout(p);t.push.apply(t,u);var mc=((Xd||{}).config||{}).update;mc?mc(f):f&&I(J,"cu",[]).push(f);if(xa){ke("me0",da,r);try{Ke(xa,c,l)}finally{ke("me1",da,r)}}return 1}
...
var u=Fe(a,t);if(u.length){u=Fe(a,k);var Q=I(J,"CP",[]),F=Q.length;Q[F]=function(da){function xa(){var ad=Q[F+1];ad&&ad()}
function mc(ad){Q[F]=null;d(u,da)&&Zd(function(){e&&e();ad()})}
if(!da)return 0;ke("ml1",u,r);0<F&&Q[F-1]?Q[F]=function(){mc(xa)}:mc(xa)};
if(u.length){var Xa="loaded_"+J.I++;Xd[Xa]=function(da){Q[F](da);Xd[Xa]=null};
a=ue(c,u,"gapi."+Xa,k);k.push.apply(k,u);ke("ml0",u,r);b.sync||Qd.___gapisync?He(a):Ie(a)}else Q[F](Td)}else d(u)&&e&&e()}
...
Xd.load=function(a,b){return Le(function(){return Me(a,b)})};function Oe(a,b){this.i=a;this.l=b;this.g=0;this.f=null}
...
var If=function(){if(oc)return Hf(/Firefox\/([0-9.]+)/);if(B||Vb||Ub)return kc;if(sc)return Qb()?Hf(/CriOS\/([0-9.]+)/):Hf(/Chrome\/([0-9.]+)/);if(tc&&!Qb())return Hf(/Version\/([0-9.]+)/);if(pc||qc){var a=/Version\/(\S+).*Mobile\/(\S+)/.exec(yb);if(a)return a[1]+"."+a[2]}else if(rc)return(a=Hf(/Android\s+([0-9.]+)/))?a:Hf(/Version\/([0-9.]+)/);return""}();function Jf(a,b,c,d,e,f,h){var g;if(g=c.offsetParent){var k="HTML"==g.tagName||"BODY"==g.tagName;if(!k||"static"!=zd(g,"position")){var l=Dd(g);if(!k){k=Jd(g);var p;if(p=k){if(p=tc)p=0<=sb(If,10);var q;if(q=ec)q=0<=sb(Gf,10);p=Xb||p||q}k=p?-g.scrollLeft:!k||Wb&&lc("8")||"visible"==zd(g,"overflowX")?g.scrollLeft:g.scrollWidth-g.clientWidth-g.scrollLeft;l=Ac(l,new D(k,g.scrollTop))}}}g=l||new D;l=Id(a);if(k=Cd(a)){var t=new ud(k.left,k.top,k.right-k.left,k.bottom-k.top);k=Math.max(l.left,t.left);p=
Math.min(l.left+l.width,t.left+t.width);k<=p&&(q=Math.max(l.top,t.top),t=Math.min(l.top+l.height,t.top+t.height),q<=t&&(l.left=k,l.top=q,l.width=p-k,l.height=t-q))}k=Cc(a);q=Cc(c);if(k.f!=q.f){p=k.f.body;q=Nc(q.f);t=new D(0,0);var r=(r=Ec(p))?Nc(r):window;b:{try{Rb(r.parent);var u=!0;break b}catch(Xa){}u=!1}if(u){u=p;do{var Q=r==q?Dd(u):Ed(u);t.x+=Q.x;t.y+=Q.y}while(r&&r!=q&&r!=r.parent&&(u=r.frameElement)&&(r=r.parent))}u=Ac(t,Dd(p));!B||9<=Number(nc)||Kc(k.f)||(u=Ac(u,Lc(k.f)));l.left+=u.x;l.top+=
u.y}a=Kf(a,b);b=l.left;a&4?b+=l.width:a&2&&(b+=l.width/2);b=new D(b,l.top+(a&1?l.height:0));b=Ac(b,g);e&&(b.x+=(a&4?-1:1)*e.x,b.y+=(a&1?-1:1)*e.y);var F;h&&(F=Cd(c))&&(F.top-=g.y,F.right-=g.x,F.bottom-=g.y,F.left-=g.x);return Lf(b,c,d,f,F,h,void 0)}
function Lf(a,b,c,d,e,f,h){a=a.clone();var g=Kf(b,c);c=Gd(b);h=h?h.clone():c.clone();a=a.clone();h=h.clone();var k=0;if(d||0!=g)g&4?a.x-=h.width+(d?d.right:0):g&2?a.x-=h.width/2:d&&(a.x+=d.left),g&1?a.y-=h.height+(d?d.bottom:0):d&&(a.y+=d.top);if(f){if(e){d=a;g=h;k=0;65==(f&65)&&(d.x<e.left||d.x>=e.right)&&(f&=-2);132==(f&132)&&(d.y<e.top||d.y>=e.bottom)&&(f&=-5);d.x<e.left&&f&1&&(d.x=e.left,k|=1);if(f&16){var l=d.x;d.x<e.left&&(d.x=e.left,k|=4);d.x+g.width>e.right&&(g.width=Math.min(e.right-d.x,
...
function Kf(a,b){return(b&8&&Jd(a)?b^4:b)&-9}
;function Mf(a){this.f=0;this.B=void 0;this.l=this.g=this.i=null;this.o=this.v=!1;if(a!=wa)try{var b=this;a.call(void 0,function(c){Nf(b,2,c)},function(c){Nf(b,3,c)})}catch(c){Nf(this,3,c)}}
...
y(ng,mg);function og(a,b){this.g=a;this.f=null;if(B&&!(9<=Number(nc))){pg||(pg=new wf);this.f=pg.get(a);this.f||(b?this.f=document.getElementById(b):(this.f=document.createElement("userdata"),this.f.addBehavior("#default#userData"),document.body.appendChild(this.f)),pg.set(a,this.f));try{this.f.load(this.g)}catch(c){this.f=null}}}
...
return d};function ug(){this.g=[];this.f=-1}
ug.prototype.set=function(a,b){b=void 0===b?!0:b;0<=a&&52>a&&0===a%1&&this.g[a]!=b&&(this.g[a]=b,this.f=-1)};
ug.prototype.get=function(a){return!!this.g[a]};
function vg(a){-1==a.f&&(a.f=Qa(a.g,function(b,c,d){return c?b+Math.pow(2,d):b},0));
return a.f}
;var wg=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{};x("yt.config_",wg);function xg(a){var b=arguments;1<b.length?wg[b[0]]=b[1]:1===b.length&&Object.assign(wg,b[0])}
function O(a,b){return a in wg?wg[a]:b}
function yg(a){return O(a,void 0)}
;var zg=[];function Ag(a){zg.forEach(function(b){return b(a)})}
function Bg(a){return a&&window.yterr?function(){try{return a.apply(this,arguments)}catch(b){Cg(b),Ag(b)}}:a}
function Cg(a,b,c,d,e){var f=v("yt.logging.errors.log");f?f(a,b,c,d,e):(f=O("ERRORS",[]),f.push([a,b,c,d,e]),xg("ERRORS",f))}
;function P(a,b){Ca(a)&&(a=Bg(a));return window.setTimeout(a,b)}
function Dg(a){window.clearTimeout(a)}
;var Eg=v("ytPubsubPubsubInstance")||new N;N.prototype.subscribe=N.prototype.subscribe;N.prototype.unsubscribeByKey=N.prototype.R;N.prototype.publish=N.prototype.J;N.prototype.clear=N.prototype.clear;x("ytPubsubPubsubInstance",Eg);var Fg=v("ytPubsubPubsubSubscribedKeys")||{};x("ytPubsubPubsubSubscribedKeys",Fg);var Gg=v("ytPubsubPubsubTopicToKeys")||{};x("ytPubsubPubsubTopicToKeys",Gg);var Hg=v("ytPubsubPubsubIsSynchronous")||{};x("ytPubsubPubsubIsSynchronous",Hg);
function Ig(a,b,c){var d=Jg();if(d){var e=d.subscribe(a,function(){var f=arguments;var h=function(){Fg[e]&&b.apply(c||window,f)};
try{Hg[a]?h():P(h,0)}catch(g){Cg(g)}},c);
Fg[e]=!0;Gg[a]||(Gg[a]=[]);Gg[a].push(e);return e}return 0}
function Kg(a){var b=Jg();b&&("number"===typeof a?a=[a]:"string"===typeof a&&(a=[parseInt(a,10)]),z(a,function(c){b.unsubscribeByKey(c);delete Fg[c]}))}
function R(a,b){var c=Jg();return c?c.publish.apply(c,arguments):!1}
...
var Qg={};function Ng(a){return Qg[a]||(Qg[a]=String(a).replace(/\-([a-z])/g,function(b,c){return c.toUpperCase()}))}
;function S(a,b){this.version=a;this.args=b}
;function T(a,b){this.topic=a;this.f=b}
T.prototype.toString=function(){return this.topic};function Rg(){}
function Sg(){}
Rg.prototype=ca(Sg.prototype);Rg.prototype.constructor=Rg;if(ja)ja(Rg,Sg);else for(var Tg in Sg)if("prototype"!=Tg)if(Object.defineProperties){var Ug=Object.getOwnPropertyDescriptor(Sg,Tg);Ug&&Object.defineProperty(Rg,Tg,Ug)}else Rg[Tg]=Sg[Tg];Rg.A=Sg.prototype;function Vg(a,b,c){isNaN(c)&&(c=void 0);var d=v("yt.scheduler.instance.addJob");d?d(a,b,c):void 0===c?a():P(a,c||0)}
Rg.prototype.start=function(){var a=v("yt.scheduler.instance.start");a&&a()};
ya(Rg);Rg.w();var Wg=v("ytPubsub2Pubsub2Instance")||new N;N.prototype.subscribe=N.prototype.subscribe;N.prototype.unsubscribeByKey=N.prototype.R;N.prototype.publish=N.prototype.J;N.prototype.clear=N.prototype.clear;x("ytPubsub2Pubsub2Instance",Wg);var Xg=v("ytPubsub2Pubsub2SubscribedKeys")||{};x("ytPubsub2Pubsub2SubscribedKeys",Xg);var Yg=v("ytPubsub2Pubsub2TopicToKeys")||{};x("ytPubsub2Pubsub2TopicToKeys",Yg);var Zg=v("ytPubsub2Pubsub2IsAsync")||{};x("ytPubsub2Pubsub2IsAsync",Zg);
x("ytPubsub2Pubsub2SkipSubKey",null);function U(a,b){var c=$g();c&&c.publish.call(c,a.toString(),a,b)}
function ah(a,b,c){var d=$g();if(!d)return 0;var e=d.subscribe(a.toString(),function(f,h){var g=v("ytPubsub2Pubsub2SkipSubKey");g&&g==e||(g=function(){if(Xg[e])try{if(h&&a instanceof T&&a!=f)try{var k=a.f,l=h;if(!l.args||!l.version)throw Error("yt.pubsub2.Data.deserialize(): serializedData is incomplete.");try{if(!k.M){var p=new k;k.M=p.version}var q=k.M}catch(t){}if(!q||l.version!=q)throw Error("yt.pubsub2.Data.deserialize(): serializedData version is incompatible.");try{h=Reflect.construct(k,Va(l.args))}catch(t){throw t.message=
"yt.pubsub2.Data.deserialize(): "+t.message,t;}}catch(t){throw t.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+a.toString()+": "+t.message,t;}b.call(c||window,h)}catch(t){Cg(t)}},Zg[a.toString()]?v("yt.scheduler.instance")?Vg(g,1,void 0):P(g,0):g())});
Xg[e]=!0;Yg[a.toString()]||(Yg[a.toString()]=[]);Yg[a.toString()].push(e);return e}
function bh(a){var b=$g();b&&("number"===typeof a&&(a=[a]),z(a,function(c){b.unsubscribeByKey(c);delete Xg[c]}))}
function $g(){return v("ytPubsub2Pubsub2Instance")}
;var ch=0;function dh(a){var b=a.__yt_uid_key;b||(b=eh(),a.__yt_uid_key=b);return b}
function fh(a,b){a=E(a);b=E(b);return!!ed(a,function(c){return c===b},!0,void 0)}
function gh(a,b){var c=Gc(document,a,null,b);return c.length?c[0]:null}
function hh(){var a=document,b;Ra(["fullscreenElement","webkitFullscreenElement","mozFullScreenElement","msFullscreenElement"],function(c){b=a[c];return!!b});
return b}
function ih(){mf(document.body,"hide-players",!1);z(Fc("preserve-players"),function(a){M(a,"preserve-players")})}
var eh=v("ytDomDomGetNextId")||function(){return++ch};
x("ytDomDomGetNextId",eh);var jh={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,screenX:1,screenY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};
function kh(a){this.type="";this.state=this.source=this.data=this.currentTarget=this.relatedTarget=this.target=null;this.charCode=this.keyCode=0;this.metaKey=this.shiftKey=this.ctrlKey=this.altKey=!1;this.clientY=this.clientX=0;this.changedTouches=this.touches=null;try{if(a=a||window.event){this.event=a;for(var b in a)b in jh||(this[b]=a[b]);var c=a.target||a.srcElement;c&&3==c.nodeType&&(c=c.parentNode);this.target=c;var d=a.relatedTarget;if(d)try{d=d.nodeName?d:null}catch(e){d=null}else"mouseover"==
...
kh.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var eb=v("ytEventsEventsListeners")||{};x("ytEventsEventsListeners",eb);var lh=v("ytEventsEventsCounter")||{count:0};x("ytEventsEventsCounter",lh);
...
function V(a,b,c,d){d=void 0===d?{}:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=mh(a,b,c,d);if(e)return e;e=++lh.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var h=f?function(g){g=new kh(g);if(!ed(g.relatedTarget,function(k){return k==a},!0))return g.currentTarget=a,g.type=b,c.call(a,g)}:function(g){g=new kh(g);
g.currentTarget=a;return c.call(a,g)};
h=Bg(h);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),nh()||"boolean"===typeof d?a.addEventListener(b,h,d):a.addEventListener(b,h,!!d.capture)):a.attachEvent("on"+b,h);eb[e]=[a,b,c,h,d];return e}
function oh(a,b,c){var d=a||document;return V(d,"click",function(e){var f=ed(e.target,function(h){return h===d||c(h)},!0);
f&&f!==d&&!f.disabled&&(e.currentTarget=f,b.call(f,e))})}
function ph(a){a=a||window.event;a=a.target||a.srcElement;3==a.nodeType&&(a=a.parentNode);return a}
var nh=ab(function(){var a=!1;try{var b=Object.defineProperty({},"capture",{get:function(){a=!0}});
window.addEventListener("test",null,b)}catch(c){}return a});
function qh(a,b,c){return oh(a,b,function(d){return K(d,c)})}
function rh(a){if(document.createEvent){var b=document.createEvent("HTMLEvents");b.initEvent("click",!0,!0);a.dispatchEvent(b)}else b=document.createEventObject(),a.fireEvent("onclick",b)}
function W(a){a&&("string"==typeof a&&(a=[a]),z(a,function(b){if(b in eb){var c=eb[b],d=c[0],e=c[1],f=c[3];c=c[4];d.removeEventListener?nh()||"boolean"===typeof c?d.removeEventListener(e,f,c):d.removeEventListener(e,f,!!c.capture):d.detachEvent&&d.detachEvent("on"+e,f);delete eb[b]}}))}
;var sh={},th="ontouchstart"in document;function uh(a,b,c){switch(a){case "mouseover":case "mouseout":var d=3;break;case "mouseenter":case "mouseleave":d=9}return ed(c,function(e){return K(e,b)},!0,d)}
function vh(a){var b="mouseover"==a.type&&"mouseenter"in sh||"mouseout"==a.type&&"mouseleave"in sh,c=a.type in sh||b;if("HTML"!=a.target.tagName&&c){if(b){b="mouseover"==a.type?"mouseenter":"mouseleave";c=sh[b];for(var d in c.g){var e=uh(b,d,a.target);e&&!ed(a.relatedTarget,function(f){return f==e},!0)&&c.J(d,e,b,a)}}if(b=sh[a.type])for(d in b.g)(e=uh(a.type,d,a.target))&&b.J(d,e,a.type,a)}}
V(document,"blur",vh,!0);V(document,"change",vh,!0);V(document,"click",vh);V(document,"focus",vh,!0);V(document,"mouseover",vh);V(document,"mouseout",vh);V(document,"mousedown",vh);V(document,"keydown",vh);V(document,"keyup",vh);V(document,"keypress",vh);V(document,"cut",vh);V(document,"paste",vh);th&&(V(document,"touchstart",vh),V(document,"touchend",vh),V(document,"touchcancel",vh));function wh(a){this.o=a;this.B={};this.K=[];this.F=[]}
m=wh.prototype;m.D=function(a){return H(a,X(this))};
function X(a,b){return"yt-uix"+(a.o?"-"+a.o:"")+(b?"-"+b:"")}
m.unregister=function(){Kg(this.K);this.K.length=0;bh(this.F);this.F.length=0};
m.init=wa;m.dispose=wa;function xh(a,b,c){a.K.push(Ig(b,c,a))}
function yh(a,b,c){a.F.push(ah(b,c,a))}
function Y(a,b,c,d){d=X(a,d);var e=w(c,a);b in sh||(sh[b]=new N);sh[b].subscribe(d,e);a.B[c]=e}
function Z(a,b,c,d){if(b in sh){var e=sh[b];cg(e,X(a,d),a.B[c]);0>=eg(e)&&(e.dispose(),delete sh[b])}delete a.B[c]}
m.P=function(a,b,c){var d=this.j(a,b);if(d&&(d=v(d))){var e=Za(arguments,2);Ya(e,0,0,a);d.apply(null,e)}};
m.j=function(a,b){return Og(a,b)};
function zh(a,b){Mg(a,"tooltip-text",b)}
;var Ah=window.yt&&window.yt.uix&&window.yt.uix.widgets_||{};x("yt.uix.widgets_",Ah);function Bh(a){var b=[];bb(a,function(c,d){var e=encodeURIComponent(String(d)),f;Aa(c)?f=c:f=[c];z(f,function(h){""==h?b.push(e):b.push(e+"="+encodeURIComponent(String(h)))})});
return b.join("&")}
function Ch(a){"?"==a.charAt(0)&&(a=a.substr(1));a=a.split("&");for(var b={},c=0,d=a.length;c<d;c++){var e=a[c].split("=");if(1==e.length&&e[0]||2==e.length)try{var f=decodeURIComponent((e[0]||"").replace(/\+/g," ")),h=decodeURIComponent((e[1]||"").replace(/\+/g," "));f in b?Aa(b[f])?Wa(b[f],h):b[f]=[b[f],h]:b[f]=h}catch(k){var g=Error("Error decoding URL component");g.params="key: "+e[0]+", value: "+e[1];"q"==e[0]?Cg(g,"WARNING",void 0,void 0,void 0):Cg(g)}}return b}
function Dh(a,b){return Eh(a,b||{},!0)}
function Eh(a,b,c){var d=a.split("#",2);a=d[0];d=1<d.length?"#"+d[1]:"";var e=a.split("?",2);a=e[0];e=Ch(e[1]||"");for(var f in b)!c&&null!==e&&f in e||(e[f]=b[f]);return nd(a,e)+d}
;function Fh(a){a=void 0===a?{}:a;Ca(a)&&(a={callback:a});if(a.gapiHintOverride||O("GAPI_HINT_OVERRIDE")){var b=document.location.href;-1!=b.indexOf("?")?(b=(b||"").split("#")[0],b=b.split("?",2),b=Ch(1<b.length?b[1]:b[0])):b={};(b=b.gapi_jsh)&&jb(a,{_c:{jsl:{h:b}}})}Me("gapi.iframes:gapi.iframes.style.common",a)}
;function Gh(){return v("gapi.iframes.getContext")()}
;function Hh(a){S.call(this,1,arguments);this.f=a}
y(Hh,S);function Ih(a){S.call(this,1,arguments);this.f=a}
y(Ih,S);function Jh(a,b,c){S.call(this,3,arguments);this.i=a;this.g=b;this.f=null!=c?!!c:null}
y(Jh,S);function Kh(a,b,c,d,e,f){S.call(this,2,arguments);this.g=a;this.f=b;this.l=c||null;this.i=d||null;this.source=e||null;this.params=f||null}
y(Kh,S);function Lh(a,b,c){S.call(this,1,arguments);this.f=a;this.g=b}
y(Lh,S);function Mh(a,b,c,d,e,f,h){S.call(this,1,arguments);this.g=a;this.o=b;this.f=c;this.v=d||null;this.l=e||null;this.i=f||null;this.source=h||null}
y(Mh,S);
var Nh=new T("subscription-batch-subscribe",Hh),Oh=new T("subscription-batch-unsubscribe",Hh),Ph=new T("subscription-subscribe",Kh),Qh=new T("subscription-subscribe-loading",Ih),Rh=new T("subscription-subscribe-loaded",Ih),Sh=new T("subscription-subscribe-success",Lh),Th=new T("subscription-subscribe-external",Kh),Uh=new T("subscription-unsubscribe",Mh),Vh=new T("subscription-unsubscirbe-loading",Ih),Wh=new T("subscription-unsubscribe-loaded",Ih),Xh=new T("subscription-unsubscribe-success",Ih),Yh=
new T("subscription-external-unsubscribe",Mh),Zh=new T("subscription-enable-ypc",Ih),$h=new T("subscription-disable-ypc",Ih),ai=new T("subscription-prefs",Jh),bi=new T("subscription-prefs-success",Jh),ci=new T("subscription-prefs-failure",Jh);function di(){var a=hh();return a?a:null}
;function ei(a,b){(a=E(a))&&a.style&&(a.style.display=b?"":"none",mf(a,"hid",!b))}
function fi(a){return(a=E(a))?"none"!=a.style.display&&!K(a,"hid"):!1}
function gi(a){z(arguments,function(b){!Ba(b)||b instanceof Element?ei(b,!0):z(b,function(c){gi(c)})})}
function hi(a){z(arguments,function(b){!Ba(b)||b instanceof Element?ei(b,!1):z(b,function(c){hi(c)})})}
;function ii(){wh.call(this,"tooltip");this.f=0;this.g={}}
y(ii,wh);ya(ii);m=ii.prototype;m.register=function(){Y(this,"mouseover",this.Y);Y(this,"mouseout",this.N);Y(this,"focus",this.ma);Y(this,"blur",this.ha);Y(this,"click",this.N);Y(this,"touchstart",this.Ha);Y(this,"touchend",this.Z);Y(this,"touchcancel",this.Z)};
m.unregister=function(){Z(this,"mouseover",this.Y);Z(this,"mouseout",this.N);Z(this,"focus",this.ma);Z(this,"blur",this.ha);Z(this,"click",this.N);Z(this,"touchstart",this.Ha);Z(this,"touchend",this.Z);Z(this,"touchcancel",this.Z);this.dispose();ii.A.unregister.call(this)};
m.dispose=function(){for(var a in this.g)this.N(this.g[a]);this.g={}};
m.Y=function(a){if(!(this.f&&1E3>Ka()-this.f)){var b=parseInt(this.j(a,"tooltip-hide-timer"),10);b&&(Pg(a,"tooltip-hide-timer"),Dg(b));b=w(function(){ji(this,a);Pg(a,"tooltip-show-timer")},this);
var c=parseInt(this.j(a,"tooltip-show-delay"),10)||0;b=P(b,c);Mg(a,"tooltip-show-timer",b.toString());a.title&&(zh(a,ki(this,a)),a.title="");b=Ea(a).toString();this.g[b]=a}};
m.N=function(a){var b=parseInt(this.j(a,"tooltip-show-timer"),10);b&&(Dg(b),Pg(a,"tooltip-show-timer"));b=w(function(){if(a){var c=E(li(this,a));c&&(mi(c),Pc(c),Pg(a,"content-id"));c=E(li(this,a,"arialabel"));Pc(c)}Pg(a,"tooltip-hide-timer")},this);
b=P(b,50);Mg(a,"tooltip-hide-timer",b.toString());if(b=this.j(a,"tooltip-text"))a.title=b;b=Ea(a).toString();delete this.g[b]};
m.ma=function(a,b){this.f=0;this.Y(a,b)};
m.ha=function(a){this.f=0;this.N(a)};
m.Ha=function(a,b,c){c.changedTouches&&(this.f=0,(a=uh(b,X(this),c.changedTouches[0].target))&&this.Y(a,b))};
m.Z=function(a,b,c){c.changedTouches&&(this.f=Ka(),(a=uh(b,X(this),c.changedTouches[0].target))&&this.N(a))};
function ni(a,b,c){zh(b,c);a=a.j(b,"content-id");(a=E(a))&&Tc(a,c)}
function ki(a,b){return a.j(b,"tooltip-text")||b.title}
function ji(a,b){if(b){var c=ki(a,b);if(c){var d=E(li(a,b));if(!d){d=document.createElement("div");d.id=li(a,b);jf(d,X(a,"tip"));var e=document.createElement("div");jf(e,X(a,"tip-body"));var f=document.createElement("div");jf(f,X(a,"tip-arrow"));var h=document.createElement("div");h.setAttribute("aria-hidden","true");jf(h,X(a,"tip-content"));var g=oi(a,b),k=li(a,b,"content");h.id=k;Mg(b,"content-id",k);e.appendChild(h);g&&d.appendChild(g);d.appendChild(e);d.appendChild(f);var l=bd(b);k=li(a,b,"arialabel");
f=document.createElement("div");L(f,X(a,"arialabel"));f.id=k;l=b.hasAttribute("aria-label")?b.getAttribute("aria-label"):"rtl"==document.body.getAttribute("dir")?c+" "+l:l+" "+c;Tc(f,l);b.setAttribute("aria-labelledby",k);k=di()||document.body;k.appendChild(f);k.appendChild(d);ni(a,b,c);(c=parseInt(a.j(b,"tooltip-max-width"),10))&&e.offsetWidth>c&&(e.style.width=c+"px",L(h,X(a,"normal-wrap")));h=K(b,X(a,"reverse"));pi(a,b,d,e,g,h)||pi(a,b,d,e,g,!h);var p=X(a,"tip-visible");P(function(){L(d,p)},0)}}}}
function pi(a,b,c,d,e,f){mf(c,X(a,"tip-reverse"),f);var h=0;f&&(h=1);var g=Gd(b);f=new D((g.width-10)/2,f?g.height:0);var k=Dd(b);Lf(new D(k.x+f.x,k.y+f.y),c,h);f=Jc(window);if(1==c.nodeType)var l=Ed(c);else c=c.changedTouches?c.changedTouches[0]:c,l=new D(c.clientX,c.clientY);c=Gd(d);var p=Math.floor(c.width/2);h=!!(f.height<l.y+g.height);g=!!(l.y<g.height);k=!!(l.x<p);f=!!(f.width<l.x+p);l=(c.width+3)/-2- -5;a=a.j(b,"force-tooltip-direction");if("left"==a||k)l=-5;else if("right"==a||f)l=20-c.width-
3;a=Math.floor(l)+"px";d.style.left=a;e&&(e.style.left=a,e.style.height=c.height+"px",e.style.width=c.width+"px");return!(h||g)}
function li(a,b,c){a=X(a)+dh(b);c&&(a+="-"+c);return a}
function oi(a,b){var c=null;$b&&K(b,X(a,"masked"))&&((c=E("yt-uix-tooltip-shared-mask"))?(c.parentNode.removeChild(c),gi(c)):(c=Oc(document,"IFRAME"),c.src='javascript:""',c.id="yt-uix-tooltip-shared-mask",jf(c,X(a,"tip-mask"))));return c}
function mi(a){var b=E("yt-uix-tooltip-shared-mask"),c=b&&ed(b,function(d){return d==a},!1,2);
b&&c&&(b.parentNode.removeChild(b),hi(b),document.body.appendChild(b))}
;function qi(a){var b=ri();if(b=window.open(b,"loginPopup","width=375,height=440,resizable=yes,scrollbars=yes",!0)){var c=Ig("LOGGED_IN",function(d){Kg(O("LOGGED_IN_PUBSUB_KEY",void 0));xg("LOGGED_IN",!0);a(d)});
xg("LOGGED_IN_PUBSUB_KEY",c);b.moveTo((screen.width-375)/2,(screen.height-440)/2)}}
function ri(){var a=document.location.protocol+"//"+document.domain+"/post_login";a=md(a,"mode","subscribe");a=md("/signin?context=popup","next",a);return a=md(a,"feature","sub_button")}
x("yt.pubsub.publish",R);function si(a){a=ti(a);return"string"===typeof a&&"false"===a?!1:!!a}
function ui(a,b){var c=ti(a);return void 0===c&&void 0!==b?b:Number(c||0)}
function ti(a){var b=O("EXPERIMENTS_FORCED_FLAGS",{});return void 0!==b[a]?b[a]:O("EXPERIMENT_FLAGS",{})[a]}
;function vi(a){var b=wi;a=void 0===a?v("yt.ads.biscotti.lastId_")||"":a;b=Object.assign(xi(b),yi(b));b.ca_type="image";a&&(b.bid=a);return b}
function xi(a){var b={};b.dt=Od;b.flash="0";a:{try{var c=a.f.top.location.href}catch(f){a=2;break a}a=c?c===a.g.location.href?0:1:2}b=(b.frm=a,b);b.u_tz=-(new Date).getTimezoneOffset();var d=void 0===d?C:d;try{var e=d.history.length}catch(f){e=0}b.u_his=e;b.u_java=!!C.navigator&&"unknown"!==typeof C.navigator.javaEnabled&&!!C.navigator.javaEnabled&&C.navigator.javaEnabled();C.screen&&(b.u_h=C.screen.height,b.u_w=C.screen.width,b.u_ah=C.screen.availHeight,b.u_aw=C.screen.availWidth,b.u_cd=C.screen.colorDepth);
...
function yi(a){var b=a.f;try{var c=b.screenX;var d=b.screenY}catch(l){}try{var e=b.outerWidth;var f=b.outerHeight}catch(l){}try{var h=b.innerWidth;var g=b.innerHeight}catch(l){}b=[b.screenLeft,b.screenTop,c,d,b.screen?b.screen.availWidth:void 0,b.screen?b.screen.availTop:void 0,e,f,h,g];c=a.f.top;try{var k=Jc(c||window).round()}catch(l){k=new Bc(-12245933,-12245933)}c=k;k={};d=new ug;n.SVGElement&&n.document.createElementNS&&d.set(0);e=sd();e["allow-top-navigation-by-user-activation"]&&d.set(1);e["allow-popups-to-escape-sandbox"]&&
d.set(2);n.crypto&&n.crypto.subtle&&d.set(3);n.TextDecoder&&n.TextEncoder&&d.set(4);d=vg(d);k.bc=d;k.bih=c.height;k.biw=c.width;k.brdim=b.join();a=a.g;return k.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[a.visibilityState||a.webkitVisibilityState||a.mozVisibilityState||""]||0,k.wgl=!!C.WebGLRenderingContext,k}
var wi=new function(){var a=window.document;this.f=window;this.g=a};
x("yt.ads_.signals_.getAdSignalsString",function(a){return Bh(vi(a))});Ka();var zi=void 0!==XMLHttpRequest?function(){return new XMLHttpRequest}:void 0!==ActiveXObject?function(){return new ActiveXObject("Microsoft.XMLHTTP")}:null;
function Ai(){if(!zi)return null;var a=zi();return"open"in a?a:null}
;var Bi={Authorization:"AUTHORIZATION","X-Goog-Visitor-Id":"SANDBOXED_VISITOR_ID","X-YouTube-Client-Name":"INNERTUBE_CONTEXT_CLIENT_NAME","X-YouTube-Client-Version":"INNERTUBE_CONTEXT_CLIENT_VERSION","X-YouTube-Device":"DEVICE","X-Youtube-Identity-Token":"ID_TOKEN","X-YouTube-Page-CL":"PAGE_CL","X-YouTube-Page-Label":"PAGE_BUILD_LABEL","X-YouTube-Variants-Checksum":"VARIANTS_CHECKSUM"},Ci="app debugcss debugjs expflag force_ad_params force_viral_ad_response_params forced_experiments innertube_snapshots innertube_goldens internalcountrycode internalipoverride absolute_experiments conditional_experiments sbb sr_bns_address".split(" "),
Di=!1;
function Ei(a,b){b=void 0===b?{}:b;if(!c)var c=window.location.href;var d=gd(a)[1]||null,e=hd(gd(a)[3]||null);d&&e?(d=c,c=gd(a),d=gd(d),c=c[3]==d[3]&&c[1]==d[1]&&c[4]==d[4]):c=e?hd(gd(c)[3]||null)==e&&(Number(gd(c)[4]||null)||null)==(Number(gd(a)[4]||null)||null):!0;d=si("web_ajax_ignore_global_headers_if_set");for(var f in Bi)e=O(Bi[f]),!e||!c&&!Fi(a,f)||d&&void 0!==b[f]||(b[f]=e);if(c||Fi(a,"X-YouTube-Utc-Offset"))b["X-YouTube-Utc-Offset"]=String(-(new Date).getTimezoneOffset());(c||Fi(a,"X-YouTube-Time-Zone"))&&
(f="undefined"!=typeof Intl?(new Intl.DateTimeFormat).resolvedOptions().timeZone:null)&&(b["X-YouTube-Time-Zone"]=f);if(c||Fi(a,"X-YouTube-Ad-Signals"))b["X-YouTube-Ad-Signals"]=Bh(vi(void 0));return b}
function Gi(a){var b=window.location.search,c=hd(gd(a)[3]||null),d=hd(gd(a)[5]||null);d=(c=c&&(c.endsWith("youtube.com")||c.endsWith("youtube-nocookie.com")))&&d&&d.startsWith("/api/");if(!c||d)return a;var e=Ch(b),f={};z(Ci,function(h){e[h]&&(f[h]=e[h])});
return Eh(a,f||{},!1)}
function Fi(a,b){var c=O("CORS_HEADER_WHITELIST")||{},d=hd(gd(a)[3]||null);return d?(c=c[d])?Ta(c,b):!1:!0}
function Hi(a,b){if(window.fetch&&"XML"!=b.format){var c={method:b.method||"GET",credentials:"same-origin"};b.headers&&(c.headers=b.headers);a=Ii(a,b);var d=Ji(a,b);d&&(c.body=d);b.withCredentials&&(c.credentials="include");var e=!1,f;fetch(a,c).then(function(h){if(!e){e=!0;f&&Dg(f);var g=h.ok,k=function(l){l=l||{};var p=b.context||n;g?b.onSuccess&&b.onSuccess.call(p,l,h):b.onError&&b.onError.call(p,l,h);b.U&&b.U.call(p,l,h)};
"JSON"==(b.format||"JSON")&&(g||400<=h.status&&500>h.status)?h.json().then(k,function(){k(null)}):k(null)}});
b.sb&&0<b.timeout&&(f=P(function(){e||(e=!0,Dg(f))},b.timeout))}else Ki(a,b)}
function Ki(a,b){var c=b.format||"JSON";a=Ii(a,b);var d=Ji(a,b),e=!1,f,h=Li(a,function(g){if(!e){e=!0;f&&Dg(f);a:switch(g&&"status"in g?g.status:-1){case 200:case 201:case 202:case 203:case 204:case 205:case 206:case 304:var k=!0;break a;default:k=!1}var l=null,p=400<=g.status&&500>g.status,q=500<=g.status&&600>g.status;if(k||p||q)l=Mi(c,g,b.Ob);if(k)a:if(g&&204==g.status)k=!0;else{switch(c){case "XML":k=0==parseInt(l&&l.return_code,10);break a;case "RAW":k=!0;break a}k=!!l}l=l||{};p=b.context||n;
...
b.Ba&&0<b.timeout&&(f=P(function(){e||(e=!0,h.abort(),Dg(f))},b.timeout))}
function Ii(a,b){b.Sb&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=yg("XSRF_FIELD_NAME"),d=b.Ia;d&&(d[c]&&delete d[c],a=Dh(a,d));return a}
function Ji(a,b){var c=yg("XSRF_FIELD_NAME"),d=yg("XSRF_TOKEN"),e=b.postBody||"",f=b.H,h=yg("XSRF_FIELD_NAME"),g;b.headers&&(g=b.headers["Content-Type"]);b.Rb||hd(gd(a)[3]||null)&&!b.withCredentials&&hd(gd(a)[3]||null)!=document.location.hostname||"POST"!=b.method||g&&"application/x-www-form-urlencoded"!=g||b.H&&b.H[h]||(f||(f={}),f[c]=d);f&&"string"===typeof e&&(e=Ch(e),jb(e,f),e=b.Ca&&"JSON"==b.Ca?JSON.stringify(e):ld(e));f=e||f&&!fb(f);!Di&&f&&"POST"!=b.method&&(Di=!0,Cg(Error("AJAX request with postData should use POST")));
return e}
function Mi(a,b,c){var d=null;switch(a){case "JSON":a=b.responseText;b=b.getResponseHeader("Content-Type")||"";a&&0<=b.indexOf("json")&&(d=JSON.parse(a));break;case "XML":if(b=(b=b.responseXML)?Ni(b):null)d={},z(b.getElementsByTagName("*"),function(e){d[e.tagName]=Oi(e)})}c&&Pi(d);
return d}
function Pi(a){if(Da(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;var d=Ib(a[b]);a[c]=d}else Pi(a[b])}}
function Ni(a){return a?(a=("responseXML"in a?a.responseXML:a).getElementsByTagName("root"))&&0<a.length?a[0]:null:null}
function Oi(a){var b="";z(a.childNodes,function(c){b+=c.nodeValue});
return b}
function Li(a,b,c,d,e,f,h){function g(){4==(k&&"readyState"in k?k.readyState:0)&&b&&Bg(b)(k)}
c=void 0===c?"GET":c;d=void 0===d?"":d;var k=Ai();if(!k)return null;"onloadend"in k?k.addEventListener("loadend",g,!1):k.onreadystatechange=g;si("debug_forward_web_query_parameters")&&(a=Gi(a));k.open(c,a,!0);f&&(k.responseType=f);h&&(k.withCredentials=!0);c="POST"==c&&(void 0===window.FormData||!(d instanceof FormData));if(e=Ei(a,e))for(var l in e)k.setRequestHeader(l,e[l]),"content-type"==l.toLowerCase()&&(c=!1);c&&k.setRequestHeader("Content-Type","application/x-www-form-urlencoded");k.send(d);
return k}
;var Qi=window,Ri=Qi.ytcsi&&Qi.ytcsi.now?Qi.ytcsi.now:Qi.performance&&Qi.performance.timing&&Qi.performance.now?function(){return Qi.performance.timing.navigationStart+Qi.performance.now()}:function(){return(new Date).getTime()};var Si=Math.pow(2,16)-1,Ti=null,Ui=0,Vi={log_event:"events",log_interaction:"interactions"},Wi=Object.create(null);Wi.log_event="GENERIC_EVENT_LOGGING";Wi.log_interaction="INTERACTION_LOGGING";var Xi=new Set(["log_event"]),Yi={},Zi=0,$i=0,aj=0,bj=v("ytLoggingTransportLogPayloadsQueue_")||{};x("ytLoggingTransportLogPayloadsQueue_",bj);var cj=v("ytLoggingTransportTokensToCttTargetIds_")||{};x("ytLoggingTransportTokensToCttTargetIds_",cj);var dj=v("ytLoggingTransportDispatchedStats_")||{};
x("ytLoggingTransportDispatchedStats_",dj);x("ytytLoggingTransportCapturedTime_",v("ytLoggingTransportCapturedTime_")||{});function ej(){Dg(Zi);Dg($i);$i=0;if(!fb(bj)){for(var a in bj){var b=Yi[a];b&&b.isReady()&&(fj(a,b),delete bj[a])}fb(bj)||gj()}}
function gj(){si("web_gel_timeout_cap")&&!$i&&($i=P(ej,6E4));Dg(Zi);Zi=P(ej,O("LOGGING_BATCH_TIMEOUT",ui("web_gel_debounce_ms",1E4)))}
function hj(a,b){b=void 0===b?"":b;bj[a]=bj[a]||{};bj[a][b]=bj[a][b]||[];return bj[a][b]}
function fj(a,b){var c=Vi[a],d=dj[a]||{};dj[a]=d;var e=Math.round(Ri());for(q in bj[a]){var f=hb,h=b.f||ij();h={client:{hl:h.gb,gl:h.fb,clientName:h.eb,clientVersion:h.innertubeContextClientVersion,configInfo:h.cb}};var g=window.devicePixelRatio;g&&1!=g&&(h.client.screenDensityFloat=String(g));g=O("EXPERIMENTS_TOKEN","");""!==g&&(h.client.experimentsToken=g);var k=g=void 0,l=[],p=O("EXPERIMENTS_FORCED_FLAGS",{});for(k in p)l.push({key:k,value:String(p[k])});k=O("EXPERIMENT_FLAGS",{});for(g in k)g.startsWith("force_")&&
void 0===p[g]&&l.push({key:g,value:String(k[g])});g=l;0<g.length&&(h.request={internalExperimentFlags:g});O("DELEGATED_SESSION_ID")&&!si("pageid_as_header_web")&&(h.user={onBehalfOfUser:O("DELEGATED_SESSION_ID")});f=f({context:h});f[c]=hj(a,q);d.dispatchedEventCount=d.dispatchedEventCount||0;d.dispatchedEventCount+=f[c].length;if(h=cj[q])a:{l=q;if(h.videoId)g="VIDEO";else if(h.playlistId)g="PLAYLIST";else break a;f.credentialTransferTokenTargetId=h;f.context=f.context||{};f.context.user=f.context.user||
{};f.context.user.credentialTransferTokens=[{token:l,scope:g}]}delete cj[q];f.requestTimeMs=e;si("unsplit_gel_payloads_in_logs")&&(f.unsplitGelPayloadsInLogs=!0);if(h=yg("EVENT_ID"))g=(O("BATCH_CLIENT_COUNTER",void 0)||0)+1,g>Si&&(g=1),xg("BATCH_CLIENT_COUNTER",g),h={serializedEventId:h,clientCounter:g},f.serializedClientEventId=h,Ti&&Ui&&si("log_gel_rtt_web")&&(f.previousBatchInfo={serializedClientEventId:Ti,roundtripMs:Ui}),Ti=h,Ui=0;jj(b,a,f,{retry:Xi.has(a),onSuccess:w(kj,this,Ri())})}if(d.previousDispatchMs){c=
...
function kj(a){Ui=Math.round(Ri()-a)}
;var lj=v("ytLoggingGelSequenceIdObj_")||{};x("ytLoggingGelSequenceIdObj_",lj);function mj(){return"INNERTUBE_API_KEY"in wg&&"INNERTUBE_API_VERSION"in wg}
function ij(){return{innertubeApiKey:yg("INNERTUBE_API_KEY"),innertubeApiVersion:yg("INNERTUBE_API_VERSION"),cb:O("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),eb:O("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:yg("INNERTUBE_CONTEXT_CLIENT_VERSION"),gb:yg("INNERTUBE_CONTEXT_HL"),fb:yg("INNERTUBE_CONTEXT_GL"),hb:yg("INNERTUBE_HOST_OVERRIDE")||"",ib:!!O("INNERTUBE_USE_THIRD_PARTY_AUTH",!1)}}
function nj(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||O("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Nb||O("AUTHORIZATION"))||(a?b="Bearer "+v("gapi.auth.getToken")().Mb:b=he([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=O("SESSION_INDEX",0),si("pageid_as_header_web")&&(d["X-Goog-PageId"]=O("DELEGATED_SESSION_ID")));return d}
function oj(a){a=Object.assign({},a);delete a.Authorization;var b=he();if(b){var c=new cf;c.update(yg("INNERTUBE_API_KEY"));c.update(b);b=c.digest();c=3;void 0===c&&(c=0);if(!vc){vc={};for(var d="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""),e=["+/=","+/","-_=","-_.","-_"],f=0;5>f;f++){var h=d.concat(e[f].split(""));uc[f]=h;for(var g=0;g<h.length;g++){var k=h[g];void 0===vc[k]&&(vc[k]=g)}}}c=uc[c];d=[];for(e=0;e<b.length;e+=3){var l=b[e],p=(f=e+1<b.length)?b[e+1]:0;k=(h=
...
pj.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.f)try{this.f.set(a,b,Ka()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(Af(b))}catch(f){return}else e=escape(b);b=this.g;xc.set(""+a,e,c,"/",void 0===b?"youtube.com":b,!1)};
pj.prototype.get=function(a,b){var c=void 0,d=!this.f;if(!d)try{c=this.f.get(a)}catch(e){d=!0}if(d&&(c=xc.get(""+a,void 0))&&(c=unescape(c),b))try{c=JSON.parse(c)}catch(e){this.remove(a),c=void 0}return c};
pj.prototype.remove=function(a){this.f&&this.f.remove(a);var b=this.g;xc.remove(""+a,"/",void 0===b?"youtube.com":b)};var qj=new pj;function rj(a,b,c,d){if(d)return null;d=qj.get("nextId",!0)||1;var e=qj.get("requests",!0)||{};e[d]={method:a,request:b,authState:oj(c),requestTime:Math.round(Ri())};qj.set("nextId",d+1,86400,!0);qj.set("requests",e,86400,!0);return d}
function sj(a){var b=qj.get("requests",!0)||{};delete b[a];qj.set("requests",b,86400,!0)}
function tj(a){var b=qj.get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(Ri())-d.requestTime)){var e=d.authState,f=oj(nj(!1));gb(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(Ri())),jj(a,d.method,e,{}));delete b[c]}}qj.set("requests",b,86400,!0)}}
;function uj(a){var b=this;this.f=null;a?this.f=a:si("delay_gel_until_config_ready")?mj()&&(this.f=ij()):this.f=ij();Vg(function(){tj(b)},0,5E3)}
uj.prototype.isReady=function(){!this.f&&mj()&&(this.f=ij());return!!this.f};
function jj(a,b,c,d){!O("VISITOR_DATA")&&.01>Math.random()&&Cg(Error("Missing VISITOR_DATA when sending innertube request."),"WARNING");var e={headers:{"Content-Type":"application/json"},method:"POST",H:c,Ca:"JSON",Ba:function(){},
...
timeout:d.timeout,withCredentials:!0},f="",h=a.f.hb;h&&(f=h);h=a.f.ib||!1;var g=nj(h,f,d);Object.assign(e.headers,g);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var k=Dh(""+f+("/youtubei/"+a.f.innertubeApiVersion+"/"+b),{alt:"json",key:a.f.innertubeApiKey}),l;if(d.retry&&si("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(l=rj(b,c,g,h))){var p=e.onSuccess,q=e.ya;e.onSuccess=function(t,r){sj(l);p(t,r)};
c.ya=function(t,r){sj(l);q(t,r)}}try{si("use_fetch_for_op_xhr")?Hi(k,e):(e.method="POST",e.H||(e.H={}),Ki(k,e))}catch(t){if("InvalidAccessError"==t)l&&(sj(l),l=0),Cg(Error("An extension is blocking network request."),"WARNING");
else throw t;}l&&Vg(function(){tj(a)},0,5E3)}
...
x("yt_logging_screen.getCurrentCsn",function(a){a=void 0===a?0:a;var b=O(Lj(a));b||0!=a||(si("kevlar_client_side_screens")||si("c3_client_side_screens")?b="UNDEFINED_CSN":b=O("EVENT_ID"));return b?b:null});
x("yt_logging_screen.setCurrentScreen",function(a,b,c){c=void 0===c?0:c;if(a!==O(Lj(c))||b!==O(Mj(c)))xg(Lj(c),a),xg(Mj(c),b),0==c&&(b=function(){setTimeout(function(){if(a){var d={clientDocumentNonce:Kj,clientScreenNonce:a};var e=void 0===e?{}:e;var f={};f.eventTimeMs=Math.round(e.timestamp||Ri());f.foregroundHeartbeatScreenAssociated=d;d=String;if(e.timestamp)var h=-1;else h=v("_lact",window),h=null==h?-1:Math.max(Ka()-h,0);f.context={lastActivityMs:d(h)};si("log_sequence_info_on_gel_web")&&e.Ea&&
(d=f.context,h=e.Ea,lj[h]=h in lj?lj[h]+1:0,d.sequence={index:lj[h],groupKey:h},e.Qb&&delete lj[e.Ea]);(e=e.Pb)?(d={},e.videoId?d.videoId=e.videoId:e.playlistId&&(d.playlistId=e.playlistId),cj[e.token]=d,e=hj("log_event",e.token)):e=hj("log_event");e.push(f);uj&&(Yi.log_event=new uj);f=ui("web_logging_max_batch")||100;d=Ri();e.length>=f?ej():10<=d-aj&&(gj(),aj=d)}},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b())});function Nj(){wh.call(this,"button");this.f=null;this.i=[];this.g={}}
y(Nj,wh);ya(Nj);m=Nj.prototype;m.register=function(){Y(this,"click",this.Ja);Y(this,"keydown",this.qa);Y(this,"keypress",this.ra);xh(this,"page-scroll",this.Za)};
m.unregister=function(){Z(this,"click",this.Ja);Z(this,"keydown",this.qa);Z(this,"keypress",this.ra);Oj(this);this.g={};Nj.A.unregister.call(this)};
m.Ja=function(a){a&&!a.disabled&&(this.toggle(a),this.click(a))};
m.qa=function(a,b,c){if(!(c.altKey||c.ctrlKey||c.shiftKey||c.metaKey)&&(b=Pj(this,a))){var d=function(h){var g="";h.tagName&&(g=h.tagName.toLowerCase());return"ul"==g||"table"==g},e;
d(b)?e=b:e=Uc(b,d);if(e){e=e.tagName.toLowerCase();if("ul"==e)var f=this.nb;else"table"==e&&(f=this.mb);f&&Qj(this,a,b,c,w(f,this))}}};
m.Za=function(){var a=this.g,b=0;for(d in a)b++;if(0!=b)for(var c in a){b=a[c];var d=H(b.activeButtonNode||b.parentNode,X(this));if(void 0==d||void 0==b)break;Rj(this,d,b,!0)}};
function Qj(a,b,c,d,e){var f=fi(c),h=9==d.keyCode;if(h||32==d.keyCode||13==d.keyCode)if(d=Sj(a,c)){if(void 0!==d.firstElementChild)b=d.firstElementChild;else for(b=d.firstChild;b&&1!=b.nodeType;)b=b.nextSibling;if("a"==b.tagName.toLowerCase()){var g=void 0===g?{}:g;var k=void 0===k?"":k;var l=void 0===l?window:l;l=l.location;g=nd(b.href,g)+k;g instanceof ub||g instanceof ub||(g="object"==typeof g&&g.T?g.S():String(g),xb.test(g)||(g="about:invalid#zClosurez"),g=new ub(vb,g));l.href=g instanceof ub&&
g.constructor===ub&&g.g===wb?g.f:"type_error:SafeUrl"}else rh(b)}else h&&Tj(a,b);else f?27==d.keyCode?(Sj(a,c),Tj(a,b)):e(b,c,d):(g=K(b,X(a,"reverse"))?38:40,d.keyCode==g&&(rh(b),d.preventDefault()))}
m.ra=function(a,b,c){c.altKey||c.ctrlKey||c.shiftKey||c.metaKey||(a=Pj(this,a),fi(a)&&c.preventDefault())};
function Sj(a,b){var c=X(a,"menu-item-highlight"),d=G(c,b);d&&M(d,c);return d}
function Uj(a,b,c){L(c,X(a,"menu-item-highlight"));var d=c.getAttribute("id");d||(d=X(a,"item-id-"+Ea(c)),c.setAttribute("id",d));b.setAttribute("aria-activedescendant",d)}
m.mb=function(a,b,c){var d=Sj(this,b),e=gh("table",b);b=Gc(document,"td",null,e);d=Vj(d,b,Gc(document,"td",null,gh("tr",e)).length,c);-1!=d&&(Uj(this,a,b[d]),c.preventDefault())};
m.nb=function(a,b,c){if(40==c.keyCode||38==c.keyCode){var d=Sj(this,b);b=Oa(Gc(document,"li",null,b),fi);Uj(this,a,b[Vj(d,b,1,c)]);c.preventDefault()}};
function Vj(a,b,c,d){var e=b.length;a=Na(b,a);if(-1==a)if(38==d.keyCode)a=e-c;else{if(37==d.keyCode||38==d.keyCode||40==d.keyCode)a=0}else 39==d.keyCode?(a%c==c-1&&(a-=c),a+=1):37==d.keyCode?(0==a%c&&(a+=c),--a):38==d.keyCode?(a<c&&(a+=e),a-=c):40==d.keyCode&&(a>=e-c&&(a-=e),a+=c);return a}
function Wj(a,b){var c=b.iframeMask;c||(c=Oc(document,"IFRAME"),c.src='javascript:""',jf(c,X(a,"menu-mask")),hi(c),b.iframeMask=c);return c}
function Rj(a,b,c,d){var e=H(b,X(a,"group")),f=!!a.j(b,"button-menu-ignore-group");e=e&&!f?e:b;f=9;var h=8,g=Id(b);if(K(b,X(a,"reverse"))){f=8;h=9;g=g.top+"px";try{c.style.maxHeight=g}catch(p){}}K(b,"flip")&&(K(b,X(a,"reverse"))?(f=12,h=13):(f=13,h=12));var k;a.j(b,"button-has-sibling-menu")?k=Bd(e):a.j(b,"button-menu-root-container")&&(k=Xj(a,b));B&&!lc("8")&&(k=null);if(k){var l=Id(k);l=new td(-l.top,l.left,l.top,-l.left)}k=new D(0,1);K(b,X(a,"center-menu"))&&(k.x-=Math.round((Gd(c).width-Gd(b).width)/
2));d&&(k.y+=Lc(document).y);if(a=Wj(a,b))b=Gd(c),a.style.width=b.width+"px",a.style.height=b.height+"px",Jf(e,f,a,h,k,l,197),d&&vd(a,"position","fixed");Jf(e,f,c,h,k,l,197)}
function Xj(a,b){if(a.j(b,"button-menu-root-container")){var c=a.j(b,"button-menu-root-container");return H(b,c)}return document.body}
m.La=function(a){if(a){var b=Pj(this,a);if(b){a.setAttribute("aria-pressed","true");a.setAttribute("aria-expanded","true");b.originalParentNode=b.parentNode;b.activeButtonNode=a;b.parentNode.removeChild(b);var c;this.j(a,"button-has-sibling-menu")?c=a.parentNode:c=Xj(this,a);c.appendChild(b);b.style.minWidth=a.offsetWidth-2+"px";var d=Wj(this,a);d&&c.appendChild(d);(c=!!this.j(a,"button-menu-fixed"))&&(this.g[dh(a).toString()]=b);Rj(this,a,b,c);Lg("yt-uix-button-menu-before-show",a,b);gi(b);d&&gi(d);
this.P(a,"button-menu-action",!0);L(a,X(this,"active"));b=w(this.Ka,this,a,!1);d=w(this.Ka,this,a,!0);c=w(this.xb,this,a,void 0);this.f&&Pj(this,this.f)==Pj(this,a)||Oj(this);R("yt-uix-button-menu-show",a);W(this.i);this.i=[V(document,"click",d),V(document,"contextmenu",b),V(window,"resize",c)];this.f=a}}};
function Tj(a,b){if(b){var c=Pj(a,b);if(c){a.f=null;b.setAttribute("aria-pressed","false");b.setAttribute("aria-expanded","false");b.removeAttribute("aria-activedescendant");hi(c);a.P(b,"button-menu-action",!1);var d=Wj(a,b),e=dh(c).toString();delete a.g[e];P(function(){d&&d.parentNode&&(hi(d),d.parentNode.removeChild(d));c.originalParentNode&&(c.parentNode.removeChild(c),c.originalParentNode.appendChild(c),c.originalParentNode=null,c.activeButtonNode=null)},1)}e=H(b,X(a,"group"));
var f=[X(a,"active")];e&&f.push(X(a,"group-active"));lf(b,f);R("yt-uix-button-menu-hide",b);W(a.i);a.i.length=0}}
m.xb=function(a,b){var c=Pj(this,a);if(c){b&&(b instanceof Fb?Lb(c,b):Tc(c,b));var d=!!this.j(a,"button-menu-fixed");Rj(this,a,c,d)}};
m.Ka=function(a,b,c){c=ph(c);var d=H(c,X(this));if(d){d=Pj(this,d);var e=Pj(this,a);if(d==e)return}d=H(c,X(this,"menu"));e=d==Pj(this,a);var f=K(c,X(this,"menu-item")),h=K(c,X(this,"menu-close"));if(!d||e&&(f||h))Tj(this,a),d&&b&&this.j(a,"button-menu-indicate-selected")&&((a=G(X(this,"content"),a))&&Tc(a,bd(c)),Yj(this,d,c))};
function Yj(a,b,c){var d=X(a,"menu-item-selected");z(Fc(d,b),function(e){M(e,d)});
L(c.parentNode,d)}
function Pj(a,b){if(!b.widgetMenu){var c=a.j(b,"button-menu-id");c=c&&E(c);var d=X(a,"menu");c?kf(c,[d,X(a,"menu-external")]):c=G(d,b);b.widgetMenu=c}return b.widgetMenu}
...
m.click=function(a){if(Pj(this,a)){var b=Pj(this,a);if(b){var c=H(b.activeButtonNode||b.parentNode,X(this));c&&c!=a?(Tj(this,c),P(w(this.La,this,a),1)):fi(b)?Tj(this,a):this.La(a)}a.focus()}this.P(a,"button-action")};
function Oj(a){a.f&&Tj(a,a.f)}
;function Zj(a){wh.call(this,a);this.i=null}
y(Zj,wh);m=Zj.prototype;m.D=function(a){var b=wh.prototype.D.call(this,a);return b?b:a};
m.register=function(){xh(this,"yt-uix-kbd-nav-move-out-done",this.hide)};
m.dispose=function(){ak(this);Zj.A.dispose.call(this)};
m.j=function(a,b){var c=Zj.A.j.call(this,a,b);return c?c:(c=Zj.A.j.call(this,a,"card-config"))&&(c=v(c))&&c[b]?c[b]:null};
m.show=function(a){var b=this.D(a);if(b){L(b,X(this,"active"));var c=bk(this,a,b);if(c){c.cardTargetNode=a;c.cardRootNode=b;ck(this,a,c);var d=X(this,"card-visible"),e=this.j(a,"card-delegate-show")&&this.j(b,"card-action");this.P(b,"card-action",a);this.i=a;hi(c);P(w(function(){e||(gi(c),R("yt-uix-card-show",b,a,c));dk(c);L(c,d);R("yt-uix-kbd-nav-move-in-to",c)},this),10)}}};
function bk(a,b,c){var d=c||b,e=X(a,"card");c=ek(a,d);var f=E(X(a,"card")+dh(d));if(f)return a=G(X(a,"card-body"),f),Sc(a,c)||(Pc(c),a.appendChild(c)),f;f=document.createElement("div");f.id=X(a,"card")+dh(d);jf(f,e);(d=a.j(d,"card-class"))&&kf(f,d.split(/\s+/));d=document.createElement("div");d.className=X(a,"card-border");b=a.j(b,"orientation")||"horizontal";e=document.createElement("div");e.className="yt-uix-card-border-arrow yt-uix-card-border-arrow-"+b;var h=document.createElement("div");h.className=
...
m.hide=function(a){if(a=this.D(a)){var b=E(X(this,"card")+dh(a));b&&(M(a,X(this,"active")),M(b,X(this,"card-visible")),hi(b),this.i=null,b.cardTargetNode=null,b.cardRootNode=null,b.cardMask&&(Pc(b.cardMask),b.cardMask=null))}};
function ak(a){a.i&&a.hide(a.i)}
m.wb=function(a,b){var c=this.D(a);if(c){if(b){var d=ek(this,c);if(!d)return;b instanceof Fb?Lb(d,b):Tc(d,b)}K(c,X(this,"active"))&&(c=bk(this,a,c),ck(this,a,c),gi(c),dk(c))}};
m.isActive=function(a){return(a=this.D(a))?K(a,X(this,"active")):!1};
function ek(a,b){var c=b.cardContentNode;if(!c){var d=X(a,"content"),e=X(a,"card-content");(c=(c=a.j(b,"card-id"))?E(c):G(d,b))||(c=document.createElement("div"));var f=c;M(f,d);L(f,e);b.cardContentNode=c}return c}
function dk(a){var b=a.cardMask;b||(b=Oc(document,"IFRAME"),b.src='javascript:""',kf(b,["yt-uix-card-iframe-mask"]),a.cardMask=b);b.style.position=a.style.position;b.style.top=a.style.top;b.style.left=a.offsetLeft+"px";b.style.height=a.clientHeight+"px";b.style.width=a.clientWidth+"px";document.body.appendChild(b)}
;function fk(){wh.call(this,"kbd-nav")}
var gk;y(fk,wh);ya(fk);m=fk.prototype;m.register=function(){Y(this,"keydown",this.oa);xh(this,"yt-uix-kbd-nav-move-in",this.wa);xh(this,"yt-uix-kbd-nav-move-in-to",this.ob);xh(this,"yt-uix-kbd-move-next",this.xa);xh(this,"yt-uix-kbd-nav-move-to",this.W)};
m.unregister=function(){Z(this,"keydown",this.oa);W(gk)};
m.oa=function(a,b,c){var d=c.keyCode;if(a=H(a,X(this)))switch(d){case 13:case 32:this.wa(a);break;case 27:c.preventDefault();c.stopImmediatePropagation();a:{for(c=qf(a,"kbdNavMoveOut");!c;){c=H(a.parentElement,X(this));if(!c)break a;c=qf(c,"kbdNavMoveOut")}c=E(c);this.W(c);R("yt-uix-kbd-nav-move-out-done",c)}break;case 40:case 38:if((b=c.target)&&K(a,X(this,"list")))switch(d){case 40:this.xa(b,a);break;case 38:d=document.activeElement==a,a=hk(a),b=a.indexOf(b),0>b&&!d||(b=d?a.length-1:(a.length+b-
1)%a.length,a[b].focus(),ik(this,a[b]))}c.preventDefault()}};
m.wa=function(a){var b=qf(a,"kbdNavMoveIn");b=E(b);jk(this,a,b);this.W(b)};
m.ob=function(a){var b=document;try{var c=b&&b.activeElement;var d=c&&c.nodeName?c:null}catch(e){d=null}jk(this,d,a);this.W(a)};
m.W=function(a){if(a)if(Yc(a))a.focus();else{var b=Uc(a,function(c){return Rc(c)?Yc(c):!1});
b?b.focus():(a.setAttribute("tabindex","-1"),a.focus())}};
function jk(a,b,c){if(b&&c)if(L(c,X(a)),a=b.id,a||(a="kbd-nav-"+Math.floor(1E6*Math.random()+1),b.id=a),b=a,pf&&c.dataset)c.dataset.kbdNavMoveOut=b;else{if(/-[a-z]/.test("kbdNavMoveOut"))throw Error("");c.setAttribute("data-"+"kbdNavMoveOut".replace(/([A-Z])/g,"-$1").toLowerCase(),b)}}
m.xa=function(a,b){var c=document.activeElement==b,d=hk(b),e=d.indexOf(a);0>e&&!c||(c=c?0:(e+1)%d.length,d[c].focus(),ik(this,d[c]))};
function ik(a,b){if(b){var c=dd(b,"LI");c&&(L(c,X(a,"highlight")),gk=V(b,"blur",w(function(d){M(d,X(this,"highlight"));W(gk)},a,c)))}}
function hk(a){if("UL"!=a.tagName.toUpperCase())return[];a=Oa(Qc(a),function(b){return"LI"==b.tagName.toUpperCase()});
return Oa(Pa(a,function(b){return fi(b)?Uc(b,function(c){return Rc(c)?Yc(c):!1}):!1}),function(b){return!!b})}
;function kk(){wh.call(this,"menu");this.g=this.f=null;this.i={};this.v={};this.l=null}
y(kk,wh);ya(kk);function lk(a){var b=kk.w();if(K(a,X(b)))return a;var c=b.D(a);return c?c:H(a,X(b,"content"))==b.f?b.g:null}
m=kk.prototype;m.register=function(){Y(this,"click",this.na);Y(this,"mouseenter",this.Xa);xh(this,"page-scroll",this.ab);xh(this,"yt-uix-kbd-nav-move-out-done",function(a){a=this.D(a);mk(this,a)});
this.l=new N};
m.unregister=function(){Z(this,"click",this.na);this.g=this.f=null;W($a(cb(this.i)));this.i={};bb(this.v,function(a){Pc(a)},this);
this.v={};ff(this.l);this.l=null;kk.A.unregister.call(this)};
m.na=function(a,b,c){a&&(b=nk(this,a),!b.disabled&&fh(c.target,b)&&ok(this,a))};
m.Xa=function(a,b,c){a&&K(a,X(this,"hover"))&&fh(c.target,nk(this,a))&&ok(this,a,!0)};
m.ab=function(){this.f&&this.g&&pk(this,this.g,this.f)};
function pk(a,b,c){var d=qk(a,b);if(d){var e=Gd(c);if(e instanceof Bc){var f=e.height;e=e.width}else throw Error("missing height argument");d.style.width=Fd(e,!0);d.style.height=Fd(f,!0)}c==a.f&&(e=9,f=8,K(b,X(a,"reversed"))&&(e^=1,f^=1),K(b,X(a,"flipped"))&&(e^=4,f^=4),a=new D(0,1),d&&Jf(b,e,d,f,a,null,197),Jf(b,e,c,f,a,null,197))}
function ok(a,b,c){rk(a,b)&&!c?mk(a,b):(sk(a,b),!a.f||fh(b,a.f)?a.Ma(b):bg(a.l,w(a.Ma,a,b)))}
m.Ma=function(a){if(a){var b=tk(this,a);if(b){Lg("yt-uix-menu-before-show",a,b);this.f?fh(a,this.f)||mk(this,this.g):(this.g=a,this.f=b,K(a,X(this,"sibling-content"))||(Pc(b),document.body.appendChild(b)),b.style.minWidth=nk(this,a).offsetWidth-2+"px");var c=qk(this,a);c&&b.parentNode&&b.parentNode.insertBefore(c,b.nextSibling);M(b,X(this,"content-hidden"));pk(this,a,b);kf(nk(this,a),[X(this,"trigger-selected"),"yt-uix-button-toggled"]);R("yt-uix-menu-show",a);uk(b);vk(this,a);R("yt-uix-kbd-nav-move-in-to",
...
m.Ya=function(a,b){var c=ph(b);c&&(fh(c,nk(this,a))||wk(this,c)||xk(this,a))};
m.yb=function(a,b){var c=ph(b);if(c){if(wk(this,c)){var d=H(c,X(this,"content")),e=dd(c,"LI");e&&d&&Sc(d,e)&&Lg("yt-uix-menu-item-clicked",c);c=H(c,X(this,"close-on-select"));if(!c)return;d=lk(c)}mk(this,d||a)}};
function sk(a,b){if(b){var c=H(b,X(a,"content"));c&&z(Fc(X(a),c),function(d){!fh(d,b)&&rk(this,d)&&xk(this,d)},a)}}
function mk(a,b){if(b){var c=[];c.push(b);var d=tk(a,b);d&&(d=Fc(X(a),d),d=Va(d),c=c.concat(d),z(c,function(e){rk(this,e)&&xk(this,e)},a))}}
function xk(a,b){if(b){var c=tk(a,b);lf(nk(a,b),[X(a,"trigger-selected"),"yt-uix-button-toggled"]);L(c,X(a,"content-hidden"));var d=tk(a,b);d&&Hc(d,{"aria-expanded":"false"});(d=qk(a,b))&&d.parentNode&&Pc(d);c&&c==a.f&&(a.g.appendChild(c),a.f=null,a.g=null,a.l&&a.l.J("ROOT_MENU_REMOVED"));R("yt-uix-menu-hide",b);c=Ea(b).toString();W(a.i[c]);delete a.i[c]}}
m.kb=function(a,b){var c=ph(b);c&&yk(this,a,c)};
m.lb=function(a,b){var c=ph(b);if(c){var d=nk(this,a);if(d&&(c=dd(c,"LI")))if(c=bd(c).trim(),d.hasChildNodes()){var e=Nj.w();(d=G(X(e,"content"),d))&&Tc(d,c)}else Tc(d,c)}};
function vk(a,b){var c=tk(a,b);if(c){z(c.children,function(e){"LI"==e.tagName&&Hc(e,{role:"menuitem"})});
Hc(c,{"aria-expanded":"true"});var d=c.id;d||(d="aria-menu-id-"+Ea(c),c.id=d);(c=nk(a,b))&&Hc(c,{"aria-controls":d})}}
function yk(a,b,c){var d=tk(a,b);d&&K(b,X(a,"checked"))&&(a=dd(c,"LI"))&&(a=G("yt-ui-menu-item-checked-hid",a))&&(z(Fc("yt-ui-menu-item-checked",d),function(e){nf(e,"yt-ui-menu-item-checked","yt-ui-menu-item-checked-hid")}),nf(a,"yt-ui-menu-item-checked-hid","yt-ui-menu-item-checked"))}
function rk(a,b){var c=tk(a,b);return c?!K(c,X(a,"content-hidden")):!1}
function uk(a){z(Gc(document,"UL",null,a),function(b){b.tabIndex=0;var c=fk.w();kf(b,[X(c),X(c,"list")])})}
function tk(a,b){var c=Og(b,"menu-content-id");return c&&(c=E(c))?(kf(c,[X(a,"content"),X(a,"content-external")]),c):b==a.g?a.f:G(X(a,"content"),b)}
function qk(a,b){var c=Ea(b).toString(),d=a.v[c];if(!d){d=Oc(document,"IFRAME");d.src='javascript:""';var e=[X(a,"mask")];z(hf(b),function(f){e.push(f+"-mask")});
kf(d,e);a.v[c]=d}return d||null}
function nk(a,b){return G(X(a,"trigger"),b)}
function wk(a,b){return fh(b,a.f)||fh(b,a.g)}
;function zk(){Zj.call(this,"clickcard");this.f={};this.g={}}
y(zk,Zj);ya(zk);m=zk.prototype;m.register=function(){zk.A.register.call(this);Y(this,"click",this.ka,"target");Y(this,"click",this.ja,"close")};
m.unregister=function(){zk.A.unregister.call(this);Z(this,"click",this.ka,"target");Z(this,"click",this.ja,"close");for(var a in this.f)W(this.f[a]);this.f={};for(a in this.g)W(this.g[a]);this.g={}};
...
m.show=function(a){zk.A.show.call(this,a);var b=this.D(a),c=Ea(a).toString();if(!Og(b,"click-outside-persists")){if(this.f[c])return;b=V(document,"click",w(this.la,this,a));var d=V(window,"blur",w(this.la,this,a));this.f[c]=[b,d]}a=V(window,"resize",w(this.wb,this,a,void 0));this.g[c]=a};
m.hide=function(a){zk.A.hide.call(this,a);a=Ea(a).toString();var b=this.f[a];b&&(W(b),this.f[a]=null);if(b=this.g[a])W(b),delete this.g[a]};
m.la=function(a,b){var c="yt-uix"+(this.o?"-"+this.o:"")+"-card",d=null;b.target&&(d=H(b.target,c)||H(lk(b.target),c));(d=d||H(document.activeElement,c)||(document.activeElement?H(lk(document.activeElement),c):null))||this.hide(a)};
m.ja=function(a){(a=H(a,X(this,"card")))&&(a=a.cardTargetNode)&&this.hide(a)};function Ak(){Zj.call(this,"hovercard")}
y(Ak,Zj);ya(Ak);m=Ak.prototype;m.register=function(){Y(this,"mouseenter",this.sa,"target");Y(this,"mouseleave",this.ua,"target");Y(this,"mouseenter",this.ta,"card");Y(this,"mouseleave",this.va,"card")};
...
m.sa=function(a){if(Bk!=a){Bk&&(this.hide(Bk),Bk=null);var b=w(this.show,this,a),c=parseInt(this.j(a,"delay-show"),10);b=P(b,-1<c?c:200);Mg(a,"card-timer",b.toString());Bk=a;a.alt&&(Mg(a,"card-alt",a.alt),a.alt="");a.title&&(Mg(a,"card-title",a.title),a.title="")}};
m.ua=function(a){var b=parseInt(this.j(a,"card-timer"),10);Dg(b);this.D(a).isCardHidable=!0;b=parseInt(this.j(a,"delay-hide"),10);b=-1<b?b:200;P(w(this.bb,this,a),b);if(b=this.j(a,"card-alt"))a.alt=b;if(b=this.j(a,"card-title"))a.title=b};
m.bb=function(a){this.D(a).isCardHidable&&(this.hide(a),Bk=null)};
m.ta=function(a){a&&(a.cardRootNode.isCardHidable=!1)};
m.va=function(a){a&&this.hide(a.cardTargetNode)};
var Bk=null;function Ck(a,b,c,d,e,f){this.f=a;this.B=null;this.i=G("yt-dialog-fg",this.f)||this.f;if(a=G("yt-dialog-title",this.i)){var h="yt-dialog-title-"+Ea(this.i);a.setAttribute("id",h);this.i.setAttribute("aria-labelledby",h)}this.i.setAttribute("tabindex","-1");this.V=G("yt-dialog-focus-trap",this.f);this.fa=!1;this.l=new N;this.F=[];this.F.push(qh(this.f,w(this.pb,this),"yt-dialog-dismiss"));this.F.push(V(this.V,"focus",w(this.Wa,this),!0));Dk(this);this.Oa=b;this.Qa=c;this.Pa=d;this.K=e;this.Ra=f;this.v=
this.o=null}
var Ek={LOADING:"loading",Kb:"content",Lb:"working"};function Fk(a,b){a.X()||a.l.subscribe("post-all",b)}
function Dk(a){a=G("yt-dialog-fg-content",a.f);var b=[];bb(Ek,function(c){b.push("yt-dialog-show-"+c)});
lf(a,b);L(a,"yt-dialog-show-content")}
m=Ck.prototype;
m.show=function(){if(!this.X()){this.B=document.activeElement;if(!this.Pa){this.g||(this.g=E("yt-dialog-bg"),this.g||(this.g=Oc(document,"div"),this.g.id="yt-dialog-bg",jf(this.g,"yt-dialog-bg"),document.body.appendChild(this.g)));var a=window,b=a.document;var c=0;if(b){c=b.body;var d=b.documentElement;if(d&&c)if(a=Jc(a).height,Kc(b)&&d.scrollHeight)c=d.scrollHeight!=a?d.scrollHeight:d.offsetHeight;else{b=d.scrollHeight;var e=d.offsetHeight;d.clientHeight!=e&&(b=c.scrollHeight,e=c.offsetHeight);c=
b>a?b>e?b:e:b<e?b:e}else c=0}this.g.style.height=c+"px";gi(this.g)}this.pa();c=Gk(this);Hk(c);this.o=V(document,"keydown",w(this.jb,this));c=this.f;d=Ig("player-added",this.pa,this);Mg(c,"player-ready-pubsub-key",d);this.Qa&&(this.v=V(document,"click",w(this.vb,this)));gi(this.f);this.i.setAttribute("tabindex","0");Ik(this);this.K||L(document.body,"yt-dialog-active");Oj(Nj.w());ak(zk.w());ak(Ak.w());R("yt-ui-dialog-show-complete",this)}};
function Jk(){return Ra(Fc("yt-dialog"),function(a){return fi(a)})}
m.pa=function(){if(!this.Ra){var a=this.f;mf(document.body,"hide-players",!0);a&&mf(a,"preserve-players",!0)}};
function Gk(a){var b=Gc(document,"iframe",null,a.f);z(b,function(c){var d=Og(c,"onload");d&&(d=v(d))&&V(c,"load",d);if(d=Og(c,"src"))c.src=d},a);
return Va(b)}
function Hk(a){z(document.getElementsByTagName("iframe"),function(b){-1==Na(a,b)&&L(b,"iframe-hid")})}
function Kk(){z(Fc("iframe-hid"),function(a){M(a,"iframe-hid")})}
m.pb=function(a){a=a.currentTarget;a.disabled||(a=Og(a,"action")||"",this.dismiss(a))};
m.dismiss=function(a){if(!this.X()){this.l.J("pre-all");this.l.J("pre-"+a);hi(this.f);ak(zk.w());ak(Ak.w());this.i.setAttribute("tabindex","-1");Jk()||(hi(this.g),this.K||M(document.body,"yt-dialog-active"),ih(),Kk());this.o&&(W(this.o),this.o=null);this.v&&(W(this.v),this.v=null);var b=this.f;if(b){var c=Og(b,"player-ready-pubsub-key");c&&(Kg(c),Pg(b,"player-ready-pubsub-key"))}this.l.J("post-all");R("yt-ui-dialog-hide-complete",this);"cancel"==a&&R("yt-ui-dialog-cancelled",this);this.l&&this.l.J("post-"+
...
m.dispose=function(){fi(this.f)&&this.dismiss("dispose");W(this.F);this.F.length=0;P(w(function(){this.B=null},this),0);
this.V=this.i=null;this.l.dispose();this.l=null;this.fa=!0};
m.Wa=function(a){a.stopPropagation();Ik(this)};
function Ik(a){P(w(function(){this.i&&this.i.focus()},a),0)}
x("yt.ui.Dialog",Ck);function Lk(){wh.call(this,"overlay");this.l=this.g=this.i=this.f=null}
y(Lk,wh);ya(Lk);m=Lk.prototype;m.register=function(){Y(this,"click",this.da,"target");Y(this,"click",this.hide,"close");Mk(this)};
m.unregister=function(){Lk.A.unregister.call(this);Z(this,"click",this.da,"target");Z(this,"click",this.hide,"close");this.l&&(Kg(this.l),this.l=null);this.g&&(W(this.g),this.g=null)};
m.da=function(a){if(!this.f||!fi(this.f.f)){var b=this.D(a);a=Nk(b,a);b||(b=a?a.overlayParentNode:null);if(b&&a){var c=!!this.j(b,"disable-shortcuts")||!1,d=!!this.j(b,"disable-outside-click-dismiss")||!1;this.f=new Ck(a,c);this.i=b;var e=G("yt-dialog-fg",a);if(e){var f=this.j(b,"overlay-class")||"",h=this.j(b,"overlay-style")||"default",g=this.j(b,"overlay-shape")||"default";f=f?f.split(" "):[];f.push(X(this,h));f.push(X(this,g));kf(e,f)}this.f.show();R("yt-uix-kbd-nav-move-to",e||a);Mk(this);c||
d||(c=w(function(k){K(k.target,"yt-dialog-base")&&Ok(this)},this),this.g=V(G("yt-dialog-base",a),"click",c));
this.P(b,"overlay-shown");R("yt-uix-overlay-shown",b)}}};
function Mk(a){a.l||(a.l=Ig("yt-uix-overlay-hide",Pk));a.f&&Fk(a.f,function(){var b=Lk.w();b.i=null;b.f.dispose();b.f=null})}
function Ok(a){if(a.f){var b=a.i;a.f.dismiss("overlayhide");b&&a.P(b,"overlay-hidden");a.i=null;a.g&&(W(a.g),a.g=null);a.f=null}}
function Nk(a,b){var c;if(a)if(c=G("yt-dialog",a)){var d=E("body-container");d&&(d.appendChild(c),a.overlayContentNode=c,c.overlayParentNode=a)}else c=a.overlayContentNode;else b&&(c=H(b,"yt-dialog"));return c}
function Qk(){var a=Lk.w();if(a.i)a=G("yt-dialog-fg-content",a.i.overlayContentNode);else a:{if(a=Fc("yt-dialog-fg-content"))for(var b=0;b<a.length;b++){var c=H(a[b],"yt-dialog");if(fi(c)){a=a[b];break a}}a=null}return a}
m.hide=function(a){a&&a.disabled||R("yt-uix-overlay-hide")};
function Pk(){Ok(Lk.w())}
m.show=function(a){this.da(a)};var Rk={},Sk=[];function Tk(a){a=H(a,"yt-uix-button-subscription-container");return G("yt-dialog",G("unsubscribe-confirmation-overlay-container",a))}
function Uk(a,b){W(Sk);Sk.length=0;Rk[b]||(Rk[b]=Tk(a));Lk.w().show(Rk[b]);var c=Qk();return new Mf(function(d){Sk.push(qh(c,function(){d()},"overlay-confirmation-unsubscribe-button"))})}
;function Vk(){var a=O("PLAYER_CONFIG");return a&&a.args&&void 0!==a.args.authuser?!0:!(!O("SESSION_INDEX")&&!O("LOGGED_IN"))}
;function Wk(){wh.call(this,"subscription-button")}
y(Wk,wh);ya(Wk);m=Wk.prototype;m.register=function(){Y(this,"click",this.ea);yh(this,Qh,this.Aa);yh(this,Rh,this.za);yh(this,Sh,this.tb);yh(this,Vh,this.Aa);yh(this,Wh,this.za);yh(this,Xh,this.ub);yh(this,Zh,this.rb);yh(this,$h,this.qb)};
m.unregister=function(){Z(this,"click",this.ea);Wk.A.unregister.call(this)};
m.isSubscribed=function(a){return!!this.j(a,"is-subscribed")};
m.ea=function(a){var b=this.j(a,"href"),c=this.j(a,"insecure");if(b)a=this.j(a,"target")||"_self",window.open(b,a);else if(!c)if(Vk()){b=this.j(a,"channel-external-id");c=this.j(a,"clicktracking");var d=Xk(this,a),e=this.j(a,"parent-url");if(this.j(a,"is-subscribed")){var f=this.j(a,"subscription-id"),h=new Mh(b,f,d,a,c,e);this.j(a,"show-unsub-confirm-dialog")?Uk(a,b).then(function(){U(Uh,h)}):U(Uh,h)}else a=this.j(a,"params"),U(Ph,new Kh(b,d,c,e,void 0,a))}else Yk(this,a)};
...
m.Ga=function(a,b,c){b?(Mg(a,"is-subscribed","true"),c&&Mg(a,"subscription-id",c)):(Pg(a,"is-subscribed"),Pg(a,"subscription-id"));Zk(this,a)};
function Xk(a,b){if(!a.j(b,"ypc-enabled"))return null;var c=a.j(b,"ypc-item-type"),d=a.j(b,"ypc-item-id");return{itemType:c,itemId:d,subscriptionElement:b}}
m.Fa=function(a,b){var c=H(a,"yt-uix-button-subscription-container");mf(c,"yt-subscription-button-disabled-mask-container",b);a.setAttribute("aria-busy",b?"true":"false");a.disabled=b};
function Zk(a,b){var c=a.j(b,"style-type"),d=!!a.j(b,"is-subscribed");c="-"+c;var e="yt-uix-button-subscribed"+c;mf(b,"yt-uix-button-subscribe"+c,!d);mf(b,e,d);a.j(b,"subscriber-count-tooltip")&&!a.j(b,"subscriber-count-show-when-subscribed")&&(c=X(ii.w()),mf(b,c,!d),b.title=d?"":a.j(b,"subscriber-count-title"));d?P(function(){L(b,"hover-enabled")},1E3):M(b,"hover-enabled")}
m.Va=function(a){var b=!!this.j(a,"ypc-item-type"),c=!!this.j(a,"ypc-item-id");!this.j(a,"ypc-enabled")&&b&&c&&(L(a,"ypc-enabled"),Mg(a,"ypc-enabled","true"))};
m.Ua=function(a){this.j(a,"ypc-enabled")&&(M(a,"ypc-enabled"),Pg(a,"ypc-enabled"))};
function $k(a,b){return Oa(Fc(X(a)),function(c){return b==this.j(c,"channel-external-id")},a)}
m.Sa=function(a,b,c){var d=Za(arguments,2);z(a,function(e){b.apply(this,Ua(e,d))},this)};
m.O=function(a,b,c){var d=$k(this,a);this.Sa.apply(this,Ua([d],Za(arguments,1)))};
function Yk(a,b){var c=w(function(d){d.discoverable_subscriptions&&xg("SUBSCRIBE_EMBED_DISCOVERABLE_SUBSCRIPTIONS",d.discoverable_subscriptions);this.ea(b)},a);
qi(c)}
;function al(a){this.f=a;this.G=null;O("SUBSCRIBE_EMBED_HOVERCARD_URL")&&(bl(this),V(this.f,"mouseover",w(this.l,this)),V(this.f,"mouseout",w(this.aa,this)),V(this.f,"click",w(this.aa,this)),ah(Sh,Ja(this.g,!0),this),ah(Xh,Ja(this.g,!1),this),cl(this))}
function bl(a){var b={url:O("SUBSCRIBE_EMBED_HOVERCARD_URL"),style:"bubble",hideClickDetection:!0,show:!1,anchor:a.f,relayOpen:"-1"};a=w(a.i,a);Gh().open(b,a)}
function cl(a){Vk()||Ig("LOGGED_IN",function(){this.G&&(this.aa(),this.G.close(),this.G=null,bl(this))},a)}
al.prototype.i=function(a){this.G=a;a=Wk.w().isSubscribed(this.f);this.g(a)};
al.prototype.l=function(){this.G&&this.G.restyle({show:!0})};
al.prototype.aa=function(){this.G&&this.G.restyle({show:!1})};
al.prototype.g=function(a){if(this.G){a={isSubscribed:a};try{this.G.send("msg-hovercard-subscription",a,void 0,v("gapi.iframes.SAME_ORIGIN_IFRAMES_FILTER"))}catch(b){}}};function dl(){Fh(function(){var a=Gd(E("yt-subscribe"));a={width:a.width,height:a.height};var b=el;Gh().ready(a,null,b)})}
function el(a){if(a.length&&a[a.length-1]){a=a[a.length-1].eurl;var b=E("yt-subscribe"),c=Wk.w();if(b=G(X(c),b))a&&(Wk.w(),Mg(b,"parent-url",a)),new al(b)}}
;function fl(a){S.call(this,1,arguments);this.f=a}
y(fl,S);function gl(a,b){S.call(this,2,arguments);this.g=a;this.f=b}
y(gl,S);function hl(a,b,c,d){S.call(this,1,arguments);this.f=b;this.itemType=c||null;this.itemId=d||null}
y(hl,S);function il(a,b){S.call(this,1,arguments);this.g=a;this.f=b||null}
y(il,S);function jl(a){S.call(this,1,arguments)}
y(jl,S);var kl=new T("ypc-core-load",fl),ll=new T("ypc-guide-sync-success",gl),ml=new T("ypc-purchase-success",hl),nl=new T("ypc-subscription-cancel",jl),ol=new T("ypc-subscription-cancel-success",il),pl=new T("ypc-init-subscription",jl);var ql=!1,rl=[];function sl(a){a.f?ql?U(Th,a):U(kl,new fl(function(){U(pl,new jl(a.f))})):tl(a.g,a.l,a.i,a.source,a.params)}
function ul(a){a.f?ql?U(Yh,a):U(kl,new fl(function(){U(nl,new jl(a.f))})):vl(a.g,a.o,a.l,a.i,a.source)}
function wl(a){xl(Va(a.f))}
function yl(a){zl(Va(a.f))}
function Al(a){Bl(a.i,a.g,a.f)}
function Cl(a){var b=a.itemId,c=a.f.subscriptionId;b&&c&&U(Sh,new Lh(b,c,a.f.channelInfo))}
function Dl(a){var b=a.f;bb(a.g,function(c,d){U(Sh,new Lh(d,c,b[d]))})}
function El(a){U(Xh,new Ih(a.g.itemId));a.f&&a.f.length&&(Fl(a.f,Xh),Fl(a.f,Zh))}
function tl(a,b,c,d,e){var f=new Ih(a);U(Qh,f);var h={};h.c=a;c&&(h.eurl=c);d&&(h.source=d);c={};(d=O("PLAYBACK_ID"))&&(c.plid=d);(d=O("EVENT_ID"))&&(c.ei=d);e&&(c.params=e);b&&Gl(b,c);Ki("/subscription_ajax?action_create_subscription_to_channel=1",{method:"POST",Ia:h,H:c,onSuccess:function(g,k){var l=k.response;U(Sh,new Lh(a,l.id,l.channel_info));l.show_feed_privacy_dialog&&R("SHOW-FEED-PRIVACY-SUBSCRIBE-DIALOG",a)},
U:function(){U(Rh,f)}})}
function vl(a,b,c,d,e){var f=new Ih(a);U(Vh,f);var h={};h.c=a;d&&(h.eurl=d);e&&(h.source=e);d={};d.c=a;d.s=b;(a=O("PLAYBACK_ID"))&&(d.plid=a);(a=O("EVENT_ID"))&&(d.ei=a);c&&Gl(c,d);Ki("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",Ia:h,H:d,onSuccess:function(){U(Xh,f)},
U:function(){U(Wh,f)}})}
function Bl(a,b,c){if(a){var d={};d.channel_id=a;switch(b){case "receive-all-updates":d.receive_all_updates=!0;break;case "receive-no-updates":d.receive_no_updates=!0;d.receive_post_updates=!1;break;case "receive-highlight-updates":d.receive_all_updates=!1;d.receive_no_updates=!1;break;default:return}null===c||d.receive_no_updates||(d.receive_post_updates=c);var e=new Jh(a,b,c);Ki("/subscription_ajax?action_update_subscription_preferences=1",{method:"POST",H:d,onError:function(){U(ci,e)},
onSuccess:function(){U(bi,e)}})}}
function xl(a){if(a.length){var b=Ya(a,0,40);U("subscription-batch-subscribe-loading");Fl(b,Qh);var c={};c.a=b.join(",");var d=function(){U("subscription-batch-subscribe-loaded");Fl(b,Rh)};
Ki("/subscription_ajax?action_create_subscription_to_all=1",{method:"POST",H:c,onSuccess:function(e,f){d();var h=f.response,g=h.id;if(Aa(g)&&g.length==b.length){var k=h.channel_info_map;z(g,function(l,p){var q=b[p];U(Sh,new Lh(q,l,k[q]))});
a.length?xl(a):U("subscription-batch-subscribe-finished")}},
onError:function(){d();U("subscription-batch-subscribe-failure")}})}}
function zl(a){if(a.length){var b=Ya(a,0,40);U("subscription-batch-unsubscribe-loading");Fl(b,Vh);var c={};c.c=b.join(",");var d=function(){U("subscription-batch-unsubscribe-loaded");Fl(b,Wh)};
Ki("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",H:c,onSuccess:function(){d();Fl(b,Xh);a.length&&zl(a)},
onError:function(){d()}})}}
function Fl(a,b){z(a,function(c){U(b,new Ih(c))})}
function Gl(a,b){var c=Ch(a),d;for(d in c)b[d]=c[d]}
;x("yt.setConfig",xg);x("yt.config.set",xg);x("ytbin.www.subscribeembed.init",function(){ql=!0;rl.push(ah(Ph,sl),ah(Uh,ul));ql||rl.push(ah(Th,sl),ah(Yh,ul),ah(Nh,wl),ah(Oh,yl),ah(ai,Al),ah(ml,Cl),ah(ol,El),ah(ll,Dl));var a=Wk.w(),b=X(a);b in Ah||(a.register(),xh(a,"yt-uix-init-"+b,a.init),xh(a,"yt-uix-dispose-"+b,a.dispose),Ah[b]=a);dl()});}).call(this);
